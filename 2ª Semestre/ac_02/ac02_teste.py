...
try:
    ...
    m7 = Socio('Caroline', '14/09/2001', '548.428.380-94', 1, 2020)
    m8 = Socio('Fernanda', '14/09/2005', '023.126.550-63', 3, 2020)
    m9 = Socio('Rogério', '14/07/1990', '012.308.030-41', 3, 2020)
...
try:
    ...
    m10 = Socio('Pedro', '091.974.110-00', '14/12/1999', 3, 2018)
    clube.associar(m10)
...
try:
    assert clube.expulsar(3, 2020) == ('Fernanda', 'Guilherme', 'Maria')
    assert clube.numero_de_socios() == 7

    assert clube.expulsar(3, 2018) == ('Pedro',)
