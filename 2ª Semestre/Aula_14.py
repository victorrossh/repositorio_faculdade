...
print('-'*30)
d = session.query(Funcionario).filter(Funcionario.salario > 1500, Funcionario.idade == 22)
for obj in resultado:
    print(obj.id, obj.nome, obj.idade, obj.salario)
...
print('-'*30)
d = session.query(Funcionario).filter(Funcionario.salario > 1500, Funcionario.idade == 22).order_by(Funcionario.nome)
for obj in resultado:
    print(obj.id, obj.nome, obj.idade, obj.salario)
